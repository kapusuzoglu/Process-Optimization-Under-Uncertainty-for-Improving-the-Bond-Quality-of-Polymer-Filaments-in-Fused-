...
T_bp = 80; % build plate temperature
% Process parameters
...
% Celcius & m/sec
TV=[258.1037 0.0158; % 1st layer -> Fval = F1+F2 = -143.74
    259.01 0.043]; % 2nd layer -> Fval = F1+F2 = -24.2395
...
[Fsol,Fval,history] = ProcessDesign_AM_sameStarting(Matrix,x_cut,layerID,ProcessParam,...
