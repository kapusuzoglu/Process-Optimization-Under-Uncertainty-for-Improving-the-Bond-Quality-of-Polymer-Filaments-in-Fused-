...
[BondLengths] = Neck_Growth_Model(ProcessParam, BondModelParam,NumTest,Ref_temp);
toc
...
function[AllBondLengths] = Neck_Growth_Model(ProcessParam,inputs,NumTest,Ref_temp)
